...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   OperatorInstance4perl(Binary__or, perl::Canned< const Wary< pm::MatrixMinor<pm::Matrix<pm::Rational>&, pm::all_selector const&, pm::Complement<pm::SingleElementSet<int const&>, int, pm::operations::cmp> const&> > >, perl::Canned< const pm::SameElementVector<pm::Rational const&> >);
   OperatorInstance4perl(Binary__or, perl::Canned< const Wary< pm::ColChain<pm::MatrixMinor<pm::Matrix<pm::Rational>&, pm::all_selector const&, pm::Complement<pm::SingleElementSet<int const&>, int, pm::operations::cmp> const&> const&, pm::SingleCol<pm::SameElementVector<pm::Rational const&> const&> > > >, perl::Canned< const pm::SameElementVector<pm::Rational const&> >);
   ...
   OperatorInstance4perl(Binary__or, perl::Canned< const Wary< pm::ColChain<pm::Matrix<pm::Rational> const&, pm::Matrix<pm::Rational> const&> > >, perl::Canned< const Matrix< Rational > >);
