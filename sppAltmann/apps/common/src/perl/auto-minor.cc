...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInstance4perl(minor_X_X_f5, perl::Canned< Wary< pm::Transposed<pm::Matrix<pm::Integer> > > >, perl::Enum<pm::all_selector>, perl::TryCanned< const Array< int > >);
   FunctionInstance4perl(minor_X_X_f5, perl::Canned< Wary< Matrix< Integer > > >, perl::TryCanned< const Array< int > >, perl::Enum<pm::all_selector>);
