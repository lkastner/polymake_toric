...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionInstance4perl(rank_X, perl::Canned< const pm::MatrixMinor<pm::Matrix<pm::Integer>&, pm::Array<int, void> const&, pm::all_selector const&> >);
   FunctionInstance4perl(rank_X, perl::Canned< const pm::RowChain<pm::MatrixMinor<pm::Matrix<pm::Integer>&, pm::Array<int, void> const&, pm::all_selector const&> const&, pm::SingleRow<pm::IndexedSlice<pm::masquerade<pm::ConcatRows, pm::Matrix_base<pm::Integer>&>, pm::Series<int, true>, void> const&> > >);
